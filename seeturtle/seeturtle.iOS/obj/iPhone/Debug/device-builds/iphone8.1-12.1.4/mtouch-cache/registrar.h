...
@class seeturtle_iOS_Effects_CustomEntryRendereriOS;
...
@interface seeturtle_iOS_Effects_CustomEntryRendereriOS : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
...
@interface EasyTipView_EasyTipView : UIView {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
